...
//***************************	
	...
	// #define GPIO_FSYNC_PIN	GPIO_Pin_15

	// #define GPIO_PORT	GPIOB
	// #define GPIO_SCK_PIN		GPIO_Pin_14

	// #define GPIO_PORT	GPIOB
	// #define GPIO_DAT_PIN		GPIO_Pin_13

	// #define PORT_CS		GPIOB
	// #define GPIO_CS_PIN		GPIO_Pin_12  //数字电位器片选

//****************************************************************

	#define FSYNC_0()		DL_GPIO_clearPins(GPIO_PORT, GPIO_FSYNC_PIN)
	#define FSYNC_1()		DL_GPIO_setPins(GPIO_PORT, GPIO_FSYNC_PIN)

	#define SCK_0()		DL_GPIO_clearPins(GPIO_PORT, GPIO_SCK_PIN)
	#define SCK_1()		DL_GPIO_setPins(GPIO_PORT, GPIO_SCK_PIN)

	#define DAT_0()		DL_GPIO_clearPins(GPIO_PORT, GPIO_DAT_PIN)
	#define DAT_1()		DL_GPIO_setPins(GPIO_PORT, GPIO_DAT_PIN)	

	#define CS_0()		DL_GPIO_clearPins(GPIO_PORT, GPIO_CS_PIN)	
	#define CS_1()		DL_GPIO_setPins(GPIO_PORT, GPIO_CS_PIN)	
...
void AD9833_Init_GPIO()
{
	...
	// GPIO_InitStructure.GPIO_Pin = GPIO_FSYNC_PIN|GPIO_SCK_PIN|GPIO_DAT_PIN|GPIO_CS_PIN; 
